...
During my thesis I explored the prevalence of measurement error in retrospective survey data, and the effectiveness of different adjustment methods in adjusting for it. As a member of the [Recounting Crime](https://recountingcrime.wordpress.com/) project I was able to apply this measurement error framework to study the 'dark figure' of crime.

------------------------------------------------------------------------

### Beyond Good and Bad Controls: 

*Endogenous Legal Factors in Sentencing Research*

::: {.callout-note collapse="true" title="Abstract"}
Observational studies of institutional decision-making often rely on explanatory variables that are themselves partly constructed through the process under investigation. In sentencing research, many legal factors are defined by the judge and may therefore act simultaneously as confounders and mediators. Controlling for them may introduce post-treatment bias, whereas omitting them may reintroduce confounding bias. We propose overcoming this impasse by conceptualising judicially-defined legal factors as variables affected by measurement error. Using a model of racial disparities in the U.S. Federal Courts, we demonstrate how Bayesian measurement error adjustments can be used as a sensitivity-analysis framework to quantify uncertainty arising from judicial disagreement and judicial prejudice. We show that even modest levels of uncertainty in discretionary legal factors can generate substantial and unpredictable bias, including attenuation of disparity estimates even when measurement errors are entirely random and unrelated to race.
:::

`Pina-Sánchez, J. and Uhl, A. Beyond good and bad controls: Endogenous legal factors in sentencing research`

------------------------------------------------------------------------

### Simulating Area-Level Population Outcomes:

*Should We Use Multilevel Regression and Poststratification Over Spatial Microsimulation?*

[![](https://img.shields.io/badge/Article-Geographical%20Analysis-blue)](https://onlinelibrary.wiley.com/doi/epdf/10.1111/gean.70049)
...
`Beecham, R., Clark, S. and Pina-Sánchez, J. (2026). Simulating Area-Level Population Outcomes: Should We Use Multilevel Regression and Poststratification Over Spatial Microsimulation?. Geographical Analysis, 5(83). https://doi.org/10.1007/s11205-025-03802-8`

------------------------------------------------------------------------

### The Effect of Counting Rules on Cross-National Comparisons of Homicide

[![](https://img.shields.io/badge/Article-Social%20Indicators%20Research-blue)](https://link.springer.com/article/10.1007/s11205-025-03802-8)\
...
`Buil-Gil, D., Pina-Sánchez, J., and Aebi, M.F. (2025). The Effect of Counting Rules on Cross-National Comparisons of Homicide. Social Indicators Research, 181(44). https://doi.org/10.1007/s11205-025-03802-8`
...
[![](https://img.shields.io/badge/Preprint-PDF-blue)](https://www.crimrxiv.com/pub/g4p1or1g/release/1)
